...
public class PlaceCustomers : MonoBehaviour
{
    ...
    [SerializeField]
    [Range(2,6)]
    public int maxSaladItem;                     //maximum number of combinations that a customer can order. Default is 3. Maximum is 6. To add more make changes to customer prefab
    ...
    void PlaceCustomer(Vector2 customerPosition,int pos)
    {
        ...
        C.GetComponent<CustomerController>().timeToDeduct = 0.1f;
